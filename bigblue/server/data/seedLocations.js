...
const diveLocations = [
  ...
  // Cocos Island, Costa Rica
  {
    ...
    features: ["sharks", "drift", "reef", "advanced"],
    facilities: ["accommodation"],
    certificationRequired: "Advanced Open Water",
  ...
  // Bunaken National Marine Park, Indonesia
  {
    ...
    features: ["reef", "wall", "turtles", "reef", "marine_protected_area"],
    facilities: ["dive_shop", "equipment_rental", "nitrox", "accommodation"],
    certificationRequired: "Open Water",
    waterTemperature: { summer: { min: 28, max: 30 }, winter: { min: 27, max: 29 } },
  ...
  // South Ari Atoll, Maldives
  {
    ...
    features: ["reef", "reef", "drift", "pristine"],
  ...
  // Komodo National Park, Indonesia
  {
    ...
    features: ["sharks", "rays", "drift", "strong_current", "reef"],
    facilities: ["dive_shop", "equipment_rental", "accommodation"],
    certificationRequired: "Advanced Open Water",
    waterTemperature: { summer: { min: 27, max: 29 }, winter: { min: 24, max: 26 } },
  ...
  // Jupiter, Florida - Shark Diving
  {
    ...
    features: ["sharks", "ledge", "drift", "reef"],
  ...
  // Roatan, Honduras - CoCo View Wall
  {
    ...
    features: ["wall", "reef", "reef", "occasional_whales"],
    facilities: ["dive_shop", "equipment_rental", "nitrox", "resort_diving"],
    certificationRequired: "Advanced Open Water",
    waterTemperature: { summer: { min: 27, max: 29 }, winter: { min: 26, max: 28 } },
  ...
  // Outer Banks, North Carolina - USS Monitor
  {
    ...
    features: ["historic_wreck", "deep", "reef", "marine_sanctuary"],
    facilities: ["accommodation", "accommodation", "accommodation"],
  ...
  // Palau - Blue Corner
  {
    ...
    features: ["reef", "shark_action", "drift_dive", "reef_hooks"],
    facilities: ["accommodation", "dive_shop", "nitrox", "accommodation"],
    certificationRequired: "Advanced Open Water",
    waterTemperature: { summer: { min: 28, max: 30 }, winter: { min: 27, max: 29 } },
  ...
  // Cocos Island, Costa Rica
  {
    ...
    features: ["reef", "reef", "reef", "accommodation"],
    facilities: ["accommodation", "nitrox", "accommodation", "accommodation"],
  ...
  // French Polynesia - Tiputa Pass, Rangiroa
  {
    ...
    features: ["dolphin_encounters", "pass_diving", "reef", "atoll"],
  ...
  // Papua New Guinea - Kimbe Bay
  {
    ...
    features: ["biodiversity_hotspot", "macro_diving", "reef", "reef"],
    facilities: ["accommodation", "dive_shop", "accommodation", "accommodation"],
    certificationRequired: "Open Water",
    waterTemperature: { summer: { min: 28, max: 30 }, winter: { min: 27, max: 29 } },
  ...
  // New Caledonia - Prony Bay
  {
    ...
    features: ["hydrothermal_vents", "reef", "stromatolites", "geological"],
  ...
  // Bahamas - Tiger Beach
  {
    ...
    facilities: ["accommodation", "shark_diving_specialists", "safety_equipment"],
    certificationRequired: "Advanced Open Water",
  ...
  // Galapagos - Darwin's Arch
  {
    ...
    features: ["reef", "reef", "reef", "reef"],
    facilities: ["accommodation", "nitrox", "accommodation"],
    certificationRequired: "Advanced Open Water + 50 dives",
  ...
  // South Africa - Aliwal Shoal
  {
    ...
    facilities: ["dive_shop", "shark_cage_diving", "accommodation", "nitrox"],
    certificationRequired: "Open Water",
  ...
  // Mozambique - Tofo Beach
  {
    ...
    features: ["manta_rays", "reef", "megafauna", "reef"],
    facilities: ["dive_shop", "manta_research", "accommodation", "backpacker_friendly"],
    certificationRequired: "Open Water",
    waterTemperature: { summer: { min: 24, max: 27 }, winter: { min: 21, max: 24 } },
    rating: { average: 4.7, count: 892 }
  },
  ...
  // Cyprus - Zenobia Wreck
  {
    ...
    facilities: ["dive_shop", "wreck_diving", "nitrox", "accommodation"],
    certificationRequired: "Advanced Open Water",
  ...
  // Scotland - Scapa Flow
  {
    ...
    facilities: ["wreck_diving_specialists", "accommodation", "historic_tours"],
    certificationRequired: "Advanced Open Water",
  ...
  // Japan - Yonaguni Monument
  {
    ...
    features: ["mysterious_ruins", "archaeological", "reef", "unique_formations"],
    facilities: ["dive_shop", "accommodation", "accommodation"],
    certificationRequired: "Advanced Open Water",
    waterTemperature: { summer: { min: 26, max: 29 }, winter: { min: 22, max: 25 } },
  ...
  // Myanmar - Burma Banks
  {
    ...
    features: ["reef", "reef", "reef", "reef"],
    facilities: ["accommodation", "accommodation", "nitrox"],
    certificationRequired: "Advanced Open Water",
    waterTemperature: { summer: { min: 28, max: 30 }, winter: { min: 26, max: 28 } },
    rating: { average: 4.7, count: 345 }
  },
  ...
  // Bangladesh - Saint Martin's Island
  {
    ...
    features: ["coral_island", "reef", "tropical_diversity", "unexplored"],
  ...
  // Sri Lanka - Kalpitiya
  {
    ...
    features: ["largest_reef", "dolphin_encounters", "accommodation", "reef"],
    facilities: ["dolphin_tours", "dive_shop", "accommodation", "kite_surfing"],
    certificationRequired: "Open Water",
    waterTemperature: { summer: { min: 27, max: 29 }, winter: { min: 25, max: 27 } },
    rating: { average: 4.5, count: 567 }
  },
  ...
  // India - Netrani Island
  {
    ...
    features: ["heart_shaped", "coral_island", "clear_waters", "reef"],
    facilities: ["day_trips", "accommodation", "basic_facilities"],
    certificationRequired: "Open Water",
    waterTemperature: { summer: { min: 27, max: 29 }, winter: { min: 24, max: 26 } },
  ...
  // Oman - Daymaniyat Islands
  {
    ...
    features: ["marine_reserve", "reef", "turtle_nesting", "reef"],
    facilities: ["accommodation", "accommodation", "accommodation"],
    certificationRequired: "Open Water",
  ...
  // Jordan - Aqaba
  {
    ...
    facilities: ["accommodation", "shore_entry", "equipment_rental", "certification"],
    certificationRequired: "Open Water",
  ...
  // Sudan - Shaab Rumi
  {
    ...
    features: ["reef", "reef", "reef", "reef"],
    facilities: ["accommodation", "accommodation", "historical_site"],
    certificationRequired: "Advanced Open Water",
  ...
  // Turkey - Kas
  {
    ...
    facilities: ["accommodation", "historical_tours", "boat_diving"],
    certificationRequired: "Open Water",
    waterTemperature: { summer: { min: 24, max: 27 }, winter: { min: 16, max: 19 } },
    rating: { average: 4.5, count: 567 }
  },
  ...
  // Senegal - Goree Island
  {
    ...
    features: ["historic_island", "reef", "atlantic_diving", "diverse_life"],
  ...
  // Cape Verde - Sal Island
  {
    ...
    facilities: ["accommodation", "shark_encounters", "volcanic_tours"],
    certificationRequired: "Open Water",
  ...
  // Nigeria - Lagos Lagoon
  {
    ...
    facilities: ["accommodation", "environmental_education"],
    certificationRequired: "Advanced Open Water",
  ...
  // Kenya - Watamu
  {
    ...
    features: ["marine_park", "turtle_nesting", "reef", "conservation"],
    facilities: ["accommodation", "accommodation", "accommodation"],
    certificationRequired: "Open Water",
    waterTemperature: { summer: { min: 26, max: 28 }, winter: { min: 24, max: 26 } },
  ...
  // Madagascar - Nosy Be
  {
    ...
    features: ["reef", "reef", "whale_migration", "biodiversity"],
    facilities: ["accommodation", "accommodation", "research_programs"],
    certificationRequired: "Open Water",
    waterTemperature: { summer: { min: 26, max: 28 }, winter: { min: 23, max: 25 } },
